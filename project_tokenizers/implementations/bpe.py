...
class BPETokenizer(BaseTokenizer):
    def __init__(self, config):
        ...
        # Keep spaces explicit in Unicode mode.
        self.tokenizer.pre_tokenizer = pre_tokenizers.Metaspace(replacement=" ", prepend_scheme="always")
        self.tokenizer.decoder = decoders.Metaspace(replacement=" ", prepend_scheme="always")
    ...
    def save(self, path):
        ...
        project_path = f"project_tokenizers/trained/{self.language}/bpe"
